...
gmsh - weerdesteijn_box_refined_surface_nondim.geo -setnumber refined_dx 5
gmsh - weerdesteijn_box_refined_surface_nondim.geo -setnumber refined_dx 10
gmsh - weerdesteijn_box_refined_surface_nondim.geo -setnumber refined_dx 20

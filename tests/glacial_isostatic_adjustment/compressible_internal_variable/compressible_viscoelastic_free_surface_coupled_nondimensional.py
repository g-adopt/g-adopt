...
parser.add_argument(
    "--case",
    default="viscoelastic-compressible-visc1e21-shear1e11-bulk2e11-lam8-dtfstart16alpha-compahpFalse_160alpha",
    type=str,
...
def viscoelastic_model(
    ...
    coupled_solver = InternalVariableSolver(
        u, approximation, dt=dt, m=m, bcs=stokes_bcs, solver_parameters="direct"
    )

...
parser.add_argument("--lateral_visc", action='store_true', help="Use a lateral viscosity field")
...
ncells = 8*2**(args.reflevel-1) #256 # 8*2**(3-1)
...
P1 = FunctionSpace(mesh, "CG", 1)  # (Incremental) Displacement function space (vector)

...
from gadopt import *
from gadopt.gplates import GplatesVelocityFunction, pyGplatesConnector, obtain_Muller_2022_SE_v1_2


def test_obtain_muller_2022_se():
    gplates_data_path = Path(__file__).resolve().parents[2] / "demos/gplates_global"
    plate_reconstruction_files_with_path = obtain_Muller_2022_SE_v1_2(gplates_data_path)
...
def test_gplates():
    ...
    mueller_2022_se = obtain_Muller_2022_SE_v1_2(gplates_data_path)

...
# The configuration test builds a Newtonian rheology (no exponent), for which
# `CoupledInternalVariableSolver` selects `ksponly`: one linear solve per step.
DIRECT_GIA_COUPLED_CPU_PARAMS = (
    dict(direct_stokes_solver_parameters) | {"snes_type": "ksponly"}
)

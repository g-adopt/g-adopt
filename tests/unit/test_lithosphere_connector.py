"""Tests for LithosphereConnector and GplatesScalarFunction.

These tests verify the lithosphere indicator functionality that combines
oceanic (age-tracked) and continental (back-rotated) data into a smooth

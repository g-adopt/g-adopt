...
def model(level, nn, do_write=False):
    ...
    NSW = FunctionSpace(mesh, "CG", 1)  # for coordinates used in analytical normal stress (vectorr)
    NSWvec = VectorFunctionSpace(mesh, "CG", 1)  # for coordinates used in analytical normal stress (vectorr)

...
plot_quantity(
    ...
    "PC_Setup_time",
    ylim=(0, 600),
    yticks=np.linspace(0, 600, 7),
)
plot_quantity(
    df["pressure_iterations"],
    "# Pressure Solve Iterations",
    "Pressure_Iterations",
    ylim=(9, 11),
    yticks=np.linspace(9, 11, 5),
)
plot_quantity(
    df["velocity_iterations"],
...
plot_quantity(
    df["energy_iterations"],
    "# Energy Solve Iterations",
    "Energy_Iterations",
    ylim=(11, 13),
    yticks=np.linspace(11, 13, 5),
)
plot_quantity(
    df["velocity_cost"],
    "Per Velocity Iteration (s)",
    "Velocity_Cost_Per_Iteration",
    ylim=(0, 300),

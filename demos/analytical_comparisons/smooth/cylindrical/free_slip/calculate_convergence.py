...
for kindex, k in enumerate(ks):
    ...
    pylab.savefig(f"FS_Velocity_Convergence_K{k}.png", bbox_inches="tight")
    pylab.savefig(f"FS_Velocity_Convergence_K{k}.pdf", bbox_inches="tight")
    pylab.close()
    ...
    pylab.grid()
    pylab.legend(numpoints=1)
    pylab.savefig(f"FS_Pressure_Convergence_K{k}.png", bbox_inches="tight")
    pylab.savefig(f"FS_Pressure_Convergence_K{k}.pdf", bbox_inches="tight")
    pylab.close()

...
def expected_errors(coupling):
    return 0 #np.loadtxt(base / f"expected-errors-{coupling}-free-surface-coupling.dat")
...
#         ("implicit-bottom", [2.0, 2.0, 2.0])]
         ("implicit-iterative-top", [2.0, 2.0, 2.0, 2.0]),
         ("implicit-iterative-bottom", [2.0, 2.0, 2.0, 2.0])]
...
test_free_surface("implicit-iterative-top", [2.0,2.0,2.0, 2.0], 0)
test_free_surface("implicit-iterative-bottom", [2.0,2.0,2.0, 2.0], 0)

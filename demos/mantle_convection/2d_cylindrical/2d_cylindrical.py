...
# solver parameters. As noted in our [previous 3-D Cartesian tutorial](../3d_cartesian), G-ADOPT's iterative solver setup is configured to use the GAMG preconditioner

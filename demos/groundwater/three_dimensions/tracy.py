...
"""
Comparison to Tracy's three dimensional exact solution
====================================================
...
dt, t_final = Constant(5e04), 5e06  # Steady state solution
#dt, t_final = Constant(1e03), 1e05 # Transient solution
...
while time < t_final:
    ...
    # Do adaptive timestepping for steady state
    if t_final > 1e05:
...
PETSc.Sys.Print("L2 error: ", sqrt(assemble((h - hExact)**2 * dx_quad)))
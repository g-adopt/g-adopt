...
def forward():
    ...
    # Function space for time-stepping
    R = FunctionSpace(mesh, "R", 0)  # Function space for real
    delta_t = Function(R, name="delta_t")
    delta_t.assign(timestepping_history.get("delta_t")[-1])  # Initial time step

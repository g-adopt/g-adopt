...
mpiexec --map-by ppr:1:node -np $PBS_NNODES tar -C $PBS_JOBFS -xf /g/data/xd2/sg8812/FD-IMAGES/fd-prefix-2024_04_08-full-openmpi407-opt-64bitInt-pyop2fixed_Update13June.tar.gz
...
mpiexec -np $PBS_NCPUS python3 -c "from adjoint import *; generate_reference_fields()" 0 >output.log 2>error.log

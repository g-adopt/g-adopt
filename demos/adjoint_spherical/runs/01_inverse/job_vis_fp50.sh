...
mpiexec -np $PBS_NCPUS bash -c "export PYTHONPYCACHEPREFIX=$PBS_JOBFS/PYCACHE/rank_\$OMPI_COMM_WORLD_RANK; python3 ../../visualisation.py" > inversion_2.log 2> warning.log

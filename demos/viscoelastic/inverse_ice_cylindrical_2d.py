...
class InverseIceCylindrical2d(InverseCylindrical2d):
    name = "inverse-ice-cylindrical-Jvelocitysepcomponents-scaleconst-noregularisation-rol-2d"
    vertical_component = 1

    def __init__(self, LOAD_ice=False, **kwargs):
        self.tape = get_working_tape()
        self.tape.clear_tape()
        checkpoint_file = "./forward-cylindrical-dx100km-nz80-dt50years-chk.h5"
...
if __name__ == "__main__":
    simulation = InverseIceCylindrical2d(dx=100*1e3, nz=80, Tend_years=10000,dt_out_years=1000,vertical_tanh_width=20e3, do_write=True)

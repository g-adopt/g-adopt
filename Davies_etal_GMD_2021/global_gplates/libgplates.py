...
rec_model = pygplate_runner(rotation_filenames=rotation_filenames, topology_filenames=topology_filenames, geologic_zero=230, nseeds=100000, nneighbours=4, delta_time=1.0)

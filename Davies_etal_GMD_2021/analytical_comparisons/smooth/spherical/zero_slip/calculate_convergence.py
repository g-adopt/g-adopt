...
pylab.semilogy(
    (levels[0], levels[-1]),
    theoretical_pressure_convergence[1, -1, :],
    "k--",
    label=r"$\mathcal{O} (\Delta x^{2.0}$)"
)
pylab.xlabel("Level of Refinement")
pylab.xlim(levels[0]-0.5, levels[-1]+0.5)
pylab.xticks(levels)
...
pylab.grid()
pylab.legend(numpoints=1)
pylab.savefig("ZS_Pressure_Convergence.png", bbox_inches="tight")
pylab.savefig("ZS_Pressure_Convergence.pdf", bbox_inches="tight")
pylab.close()

...
def model(ref_level, radial_layers):
    ...
    solution_upper = assess.SphericalStokesSolutionDeltaZeroSlip(l, m, +1, nu=float(mu), rp=rp)
    solution_lower = assess.SphericalStokesSolutionDeltaZeroSlip(l, m, -1, nu=float(mu), rp=rp)

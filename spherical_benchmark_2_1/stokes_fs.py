...
nitsche_fs  = - dot(N,n)*dot(n,trac(u,p))*ds_tb - dot(u,n)*dot(n,trac(N,M))*ds_tb + beta/h*dot(u,n)*dot(N,n)*ds_tb
...
for timestep in range(0,max_timesteps):
    ...
    solve(F_stokes==0, z, solver_parameters=stokes_solver_parameters, appctx={'mu': mu})

...
# This is the permanent link to all Zenodo releases
permanent_link = urllib.request.urlopen("https://zenodo.org/doi/10.5281/zenodo.5644391")
# geturl() returns the redirected link to the latest zenodo release so this returns the
# record id for the latest upload.
record_id = permanent_link.geturl().split("/")[-1]

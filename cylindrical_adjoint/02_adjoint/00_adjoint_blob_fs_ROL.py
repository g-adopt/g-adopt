...
# top boundary (prescribed from file) 
bcv_t = DirichletBC(Z.sub(0),        0.0, (top_id))
...
while my_time < simu_time:
    ...
    solve(F_stokes==0, z, bcs=[bcv_l, bcv_r, bcv_t, bcv_b], solver_parameters=stokes_solver_parameters)

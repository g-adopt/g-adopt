...
# Solver options for iterative option (default for 3D)
...
# Solver options for direct option (default for 2D)
...
class RichardsSolver(SolverConfigurationMixin):
    ...
    **Note**: The solution field is updated in place.
    ...
    Args:
      ...
      source_term:
        UFL expression to describe a source/sink term (default is 0)
      delta_t:
    ...
    def __init__(
        ...
        *,
        ...
        if solution_old is not None:
            self.solution_old = solution_old
        else:
    ...
    def set_equation(self) -> None:
        ...
        self.equation.solution_old = self.solution_old

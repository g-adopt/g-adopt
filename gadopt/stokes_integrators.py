...
class StokesSolver:
    ...
    ### Valid keys for null space options
    |        Name         |                      Description                       |
    | :------------------ | :----------------------------------------------------: |
    | nullspace           | Kernel of the operator                                 |
    | transpose_nullspace | Kernel of the operator's transpose                     |
    | near_nullspace      | Operator's smallest eigenmodes (e.g. rigid body modes) |
    ...
    Arguments:
      ...
      nullspace:
        Dictionary of null space options generated by `create_stokes_nullspace`
